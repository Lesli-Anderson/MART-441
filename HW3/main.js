function storyFunction(choice) {
    ...
    if (choice == 1 && answer1 == "Yes") {
        ...
        document.getElementById("story").innerHTML = "You turn around to run away and something in your mind says 'Wait!'";
        document.getElementById("choice1").innerHTML = "Go ahead and be brave";
        document.getElementById("choice2").innerHTML = "No. Forget that start running away.";
    ...
    } else if (choice == 2 && answer2 == "No. Forget that start running away.") {
